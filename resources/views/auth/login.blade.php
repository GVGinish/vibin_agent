                     ...
                     <div class="card mt-4">
                        <div class="card-body p-4">
                           <div class="text-center mt-2">
                              ...
                              <p class="text-muted">Sign in to continue to View.</p>
                           </div>
                           <!-- Session Status -->
                           ...
                           <form method="POST" action="{{ route('login') }}">
                              ...
                              <div>
                                 ...
                                 <x-text-input id="email" class="form-control" type="email" name="email" value="vibin@gmail.com" required autofocus autocomplete="username" />
