                                             ...
                                             <tbody>
                                                ...
                                                @foreach($monthly as $mon)
                                                   <tr>
                                                      ...
                                                      <td>{{$mon->policy_number}}</td>
                                                      <td>{{$mon->premium_amount}}</td>
                                                      <td>{{$mon->premium_term}}</td>
                                                      <td>{{$mon->maturity_term}}</td>
                                             ...
                                             <tbody>
                                                ...
                                                @foreach($Quarterly as $Qua)
                                                   <tr>
                                                      ...
                                                      <td>{{$Qua->policy_number}}</td>
                                                      <td>{{$Qua->premium_amount}}</td>
                                                      <td>{{$Qua->premium_term}}</td>
                                                      <td>{{$Qua->maturity_term}}</td>
                                                      <td><a href=""class="btn btn-sm btn-primary">Add new policy</a></td>
                                                   </tr>
                                                 @endforeach  
                                                </tbody>                                                    
                                             ...
                                             <tbody>
                                                ...
                                                @foreach($HalfYearly as $half)
                                                   <tr>
                                                      ...
                                                      <td>{{$half->policy_number}}</td>
                                                      <td>{{$half->premium_amount}}</td>
                                                      <td>{{$half->premium_term}}</td>
                                                      <td>{{$half->maturity_term}}</td>
                                                      <td><a href=""class="btn btn-sm btn-primary">Add new policy</a></td>
                                                   </tr>
                                                 @endforeach  
                                                </tbody>
                                             ...
                                             <tbody>
                                                ...
                                                @foreach($Yearly as $Year)
                                                   <tr>
                                                      ...
                                                      <td>{{$Year->policy_number}}</td>
                                                      <td>{{$Year->premium_amount}}</td>
                                                      <td>{{$Year->premium_term}}</td>
                                                      <td>{{$Year->maturity_term}}</td>                                                    
                                                      <td><a href=""class="btn btn-sm btn-primary">Add new policy</a></td>
                                                   </tr>
                                                 @endforeach  
                                                </tbody>
