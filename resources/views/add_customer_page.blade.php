                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="steparrow-gen-info-Fathername-input" name="father_name" placeholder="Enter Father name" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="steparrow-gen-info-dob-input" name="dob" placeholder="Enter date of birth" required max="{{date('Y-m-d')}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="steparrow-gen-info-ifsc-input" name="ifsc" placeholder="Enter IFSC" required>
                        </div>
                    </div>
                </div>
            </div>
