            ...
            <div id="scrollbar">
               <div class="container-fluid">
                  ...
                  <ul class="navbar-nav" id="navbar-nav">
                     ...
                     <li class="nav-item">
                        <a class="nav-link menu-link" href="{{route('add_customer_page',['type'=>'new'])}}">
                        <i class="bx bx-layout"></i> <span data-key="t-widgets">Add New Policy</span>
                        </a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link menu-link" href="{{route('personal_detail')}}">
                        <i class="bx bx-layer"></i> <span data-key="t-widgets">Personal Details</span>
                        </a>
                     </li>
                  </ul>
               </div>
