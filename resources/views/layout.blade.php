...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
   <!-- Mirrored from themesbrand.com/velzon/html/default/apps-api-key.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 11:49:38 GMT -->
   <head>
      <meta charset="utf-8" />
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link collapsed active" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarApps">
                            ...
                            <div class="collapse menu-dropdown show" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="apps-api-key.html" class="nav-link active" data-key="t-api-key">API Key</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarPages">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarBlogs" class="nav-link collapsed" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarBlogs">
...
@yield('script')
   ...
   <!-- Mirrored from themesbrand.com/velzon/html/default/apps-api-key.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 11:49:39 GMT -->
</html>