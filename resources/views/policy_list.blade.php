                                 ...
                                 <div class="mt-xl-0">
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="cus">
                                             <div class="cus-view">
                                             <h5>Customer: <span style="color:#0ab39c">{{ $item->username }}</span></h5>
                                             </div>
                                             <div class="cus-view">
                                             <h5>Mobile: <span style="color:#0ab39c">{{ $item->phone }}</span></h5>
                                       ...
                                       <div class="col-md-6">
                                          <div class="cus">
                                             <div class="cus-view">
                                             <h5>DOB: <span style="color:#0ab39c">{{ date('d M,Y',strtotime($item->dob)) }}</span></h5>

                                             </div>
                                             <div class="cus-view">
                                             <h5>Email: <span style="color:#0ab39c">{{ $item->email }}</span></h5p>
                                             </div>
